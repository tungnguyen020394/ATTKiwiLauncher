...
import com.att.kiwilauncher.util.MediaPlayerControl;
...
public class VideoFullTest extends AppCompatActivity implements MediaPlayerControl {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_full_test);
    }
